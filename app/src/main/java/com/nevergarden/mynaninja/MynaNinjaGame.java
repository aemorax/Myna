...
public class MynaNinjaGame extends Myna {
    ...
    public void loadAssets() {
        assetManager.loadTexture(R.drawable.clouds);
        assetManager.loadTexture(R.drawable.bg_layer2);
        assetManager.loadTexture(R.drawable.bg_layer1);
        assetManager.loadTexture(R.drawable.dirt);
        assetManager.loadTexturePackerJsonAtlas(R.drawable.ninja_myna, R.raw.ninja_myna);
